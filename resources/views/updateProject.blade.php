    ...
    <div class="col-sm-6 col-md-4 col-md-offset-4 content-box">
        <form action="/projects/{{ $project->id }}/edit" method="post" class="form" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" style="color:black" value={{ $project->title }}> <br>
            </div>

            <div class="form-group">
                <label for="body">Project description:</label><br>
                <textarea class="form-control" name="body" rows="3">{{ $project->body }}</textarea>
                <br>
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default">Update my project</button>
            </div>
